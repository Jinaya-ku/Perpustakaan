...
<head>
    ...
    <title>Tambah Pinjaman - Perpustakaan</title>
...
<body class="bg-gray-100">
    <div class="flex">
        ...
        <div class="flex-1 p-10 content content-expanded" id="mainContent">
            ...
            <h1 class="text-3xl font-bold mb-6">Tambah Dipinjam</h1>
            <div class="bg-white p-8 rounded-lg shadow-lg">
                <form method="POST" action="{{route('admin.tambahPeminjamanAction')}}">
                    @csrf
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <label class="block text-gray-700">Nama Peminjam</label>
                            <select name="user" id="user_id" class="w-full mt-2 p-2 border rounded">
                        ...
                        <div>
                            ...
                            <select name="buku" id="buku_id" class="w-full mt-2 p-2 border rounded">
                        ...
                        <div>
                            ...
                            <input name="tanggal_peminjaman" type="date"class="w-full mt-2 p-2 border rounded" type="text"/>
                        </div>
                        <div>
                            <label class="block text-gray-700">Tanggal Pengembalian</label>
                            <input name="tanggal_pengembalian" type="date" class="w-full mt-2 p-2 border rounded" type="text"/>
                        </div>
                        <div>
