    ...
    <div class="flex">
        ...
        <div class="flex-1 p-10 content content-expanded" id="mainContent">
            ...
            <div class="bg-white p-8 rounded-lg shadow-lg">
                <form method="POST" action="{{route('admin.tambahBukuAction')}}">
                    @csrf
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <label class="block text-gray-700">Judul Buku</label>
                            <input name="judul" class="w-full mt-2 p-2 border rounded" type="text"/>
                        </div>
                        <div>
                            <label class="block text-gray-700">Penulis</label>
                            <input name="penulis" class="w-full mt-2 p-2 border rounded" type="text"/>
                        </div>
                        <div>
                            <label class="block text-gray-700">Penerbit</label>
                            <input name="penerbit" class="w-full mt-2 p-2 border rounded" type="text"/>
                        </div>
                        <div>
                            <label class="block text-gray-700">Tanggal Terbit</label>
                            <input name="tanggal_terbit" type="date" class="w-full mt-2 p-2 border rounded" type="text"/>
                        </div>
                        <div>
                            <label class="block text-gray-700">Gambar Buku</label>
                            <input type="file" name="gambar_buku" class="w-full mt-2 p-2 border rounded" type="text"/>
                        </div>
                        <div>
                            <label class="block text-gray-700">Stok</label>
                            <input name="stok" class="w-full mt-2 p-2 border rounded" type="text"/>
                        </div>
                        <div>
                            <label class="block text-gray-700">Kategori</label>
                            <select name="kategori" id="kategori" class="w-full mt-2 p-2 border rounded">
