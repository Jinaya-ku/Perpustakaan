    ...
    <div class="flex">
        ...
        <div class="flex-1 p-10 content content-expanded" id="mainContent">
            ...
            <div class="bg-white p-8 rounded-lg shadow-lg">
                <form method="POST" action="{{route('admin.editBukuAction', $buku->id)}}">
                    @csrf
                    @method('PUT')
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <label class="block text-gray-700">Judul Buku</label>
                            <input name="judul" class="w-full mt-2 p-2 border rounded" type="text" value="{{$buku->judul}}"/>
                        </div>
                        <div>
                            <label class="block text-gray-700">Penulis</label>
                            <input name="penulis" class="w-full mt-2 p-2 border rounded" type="text" value="{{$buku->penulis}}"/>
                        </div>
                        <div>
