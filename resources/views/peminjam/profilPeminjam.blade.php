 ...
 <body class="bg-gray-100">
  <div class="flex">
   ...
   <div class="w-64 bg-gradient-to-r from-purple-400 to-blue-500 h-screen shadow-lg fixed flex flex-col justify-between sidebar sidebar-closed" id="sidebar">
    <div>
     <div class="p-6">
      <a class="text-white text-2xl font-bold" href="dashboard.html">
       Perpustakaan
      </a>
     </div>
     <nav class="mt-10">
      <a class="block py-3 px-4 rounded transition duration-200 hover:bg-purple-500 text-white" href="{{route('peminjam.dashboard')}}">
    ...
    <div class="mb-10">
     ...
     <a class="block py-3 px-4 rounded transition duration-200 hover:bg-purple-500 text-white" href="{{route('peminjam.profilPeminjam')}}">
